...
<table class="data-table">
        ...
        <?php 
            ...
            while ($row = mysqli_fetch_array($select_exam)) {
                ...
                $querya = "SELECT * FROM exam WHERE ex_id='$eno'AND status='active' ORDER BY exam_date DESC ";
                ...
                echo "<td>$noofque</td>";
                echo "<td>$descr</td>";
                echo "<td><a class='btn btn-info btn-sm' href='quiz/start.php?eno=$eno' class='start'>Attempt Exam</a></td>";
                echo "</tr>";
