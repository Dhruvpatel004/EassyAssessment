...
<body onclick="openFullscreen();" ondblclick="openFullscreen();"  id="body">
    ...
    <h1>
        ...
        <button ><a href = "mailto: 21cs041@charusat.edu.in">Send Email</a></button>

    </h1
    >
    <h1>
        21cs037@charusat.edu.in
        <button ><a href = "mailto: 21cs037@charusat.edu.in">Send Email</a></button>
    </h1>
    <h1>
        21cs036@charusat.edu.in
        <button ><a href = "mailto: 21cs046@charusat.edu.in">Send Email</a></button>
    </h1>
